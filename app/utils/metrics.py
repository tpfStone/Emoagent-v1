...
sessions_total = Counter("emoagent_sessions_total", "Total number of sessions created")

messages_total = Counter(
    "emoagent_messages_total", "Total number of messages processed"
)

crisis_triggered = Counter(
    "emoagent_crisis_total", "Total number of crisis detections", ["category"]
)
...
emotion_distribution = Gauge(
    "emoagent_emotion_distribution", "Current emotion distribution", ["emotion"]
)

active_sessions = Gauge(
    "emoagent_active_sessions", "Number of currently active sessions"
)
...
rating_submissions = Counter(
    "emoagent_rating_submissions_total", "Total number of rating submissions", ["type"]
)
